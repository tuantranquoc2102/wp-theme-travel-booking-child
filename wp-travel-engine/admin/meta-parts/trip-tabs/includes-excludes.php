...
// Custom default content cho cost includes/excludes
$default_includes_content = apply_filters('wte_default_cost_includes_content', 
	"Xe ô tô đời mới, máy lạnh\nHướng dẫn viên kinh nghiệm\nBảo hiểm du lịch\nNước uống trên xe\nKhăn lạnh, kẹo\nVé tham quan theo chương trình\nCơm trưa tại nhà hàng địa phương"
);

$default_excludes_content = apply_filters('wte_default_cost_excludes_content',
	"Chi phí cá nhân\nĐồ uống có cồn\nTip hướng dẫn viên và tài xế\nChi phí phát sinh ngoài chương trình\nThuế VAT"
);

$cost_includes_content = isset( $wp_travel_engine_setting['cost']['cost_includes'] ) ? $wp_travel_engine_setting['cost']['cost_includes'] : $default_includes_content;

$cost_excludes_content = isset( $wp_travel_engine_setting['cost']['cost_excludes'] ) ? $wp_travel_engine_setting['cost']['cost_excludes'] : $default_excludes_content;
?>
	...
	<div class="wpte-form-block">
		<div class="wpte-form-content">
			<div class="wpte-field wpte-text wpte-floated">
				...
				<input type="text" name="wp_travel_engine_setting[cost_tab_sec_title]" value="<?php echo esc_attr( $cost_tab_sec_title ); ?>" placeholder="<?php esc_attr_e( 'Enter Here', 'wp-travel-engine' ); ?>">
